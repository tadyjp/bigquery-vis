...
var lexTests = []lexTest{
	...
	// 	{Type: token.STRING_LITERAL, Literal: "abc"},
	// 	tEOF,
	// }},
	// {"string", `"it's"`, []token.Token{
	// 	{Type: token.STRING_LITERAL, Literal: "it's"},
	// 	tEOF,
	// }},
	// {"string", `'it\'s'`, []token.Token{
	// 	{Type: token.STRING_LITERAL, Literal: "it's"},
	...
	// 	{Type: token.STRING_LITERAL, Literal: `Title: "Boy"`},
	// 	tEOF,
	// }},
	// {"string", `"""abc"""`, []token.Token{
	// 	{Type: token.STRING_LITERAL, Literal: `abc`},
	...
	{"array", "['x', 'y', 'xy']", []token.Token{
		{Type: token.LSQUARE, Literal: "["},
		{Type: token.STRING_LITERAL, Literal: "x"},
		{Type: token.COMMA, Literal: ","},
		{Type: token.STRING_LITERAL, Literal: "y"},
		{Type: token.COMMA, Literal: ","},
		{Type: token.STRING_LITERAL, Literal: "xy"},
		{Type: token.RSQUARE, Literal: "]"},
		tEOF,
	}},
	{"array", "ARRAY[1]", []token.Token{
		{Type: token.ARRAY, Literal: "ARRAY"},
		{Type: token.LSQUARE, Literal: "["},
		{Type: token.UINT, Literal: "1"},
		{Type: token.RSQUARE, Literal: "]"},
		tEOF,
	}},
	{"array", "ARRAY<string>['x']", []token.Token{
		{Type: token.ARRAY, Literal: "ARRAY"},
